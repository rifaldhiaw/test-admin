...
import {
  UsePaginationItem,
  UsePaginationProps,
} from "@/lib/hooks/usePagination.type";
...
export const Pagination = ({ children, ...rest }: PaginationProps) => {
  ...
  return (
    <PagerContext.Provider value={context}>{children}</PagerContext.Provider>
  );
};
    ...
    return (
      <li className="hidden sm:flex">
        <Primitive.button
          ...
          {...rest}
        >
          {rest.asChild ? rest.children : <ChevronsLeft size={20} />}
        </Primitive.button>
      </li>
    );
  }
    ...
    return (
      <li className="hidden sm:flex">
        <Primitive.button
          ...
          {...rest}
        >
          {rest.asChild ? rest.children : <ChevronLeft size={20} />}
        </Primitive.button>
      </li>
    );
  }
    ...
    return (
      <li className="hidden sm:flex">
        <Primitive.button
          ...
          {...rest}
        >
          {rest.asChild ? rest.children : <ChevronRight size={20} />}
        </Primitive.button>
      </li>
    );
  }
    ...
    return (
      <li className="hidden sm:flex">
        <Primitive.button
          ...
          {...rest}
        >
          {rest.asChild ? rest.children : <ChevronsRight size={20} />}
        </Primitive.button>
      </li>
    );
  }
